...
describe 'required files logstash', :if => ['debian', 'ubuntu'].include?(os[:family]) do
...
describe 'required files logstash::agent' do
...
describe 'required files logstash::elasticsearch' do
...
describe 'required files logstash::indexer' do
...
describe 'required files logstash::redis' do
